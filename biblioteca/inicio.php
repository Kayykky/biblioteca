...
<div id="inicio" class="tab">
  ...
  <div id="pesquisar" class="tab" style="display:none">
    <form action="?page=pesquisar" method="post">
      <fieldset class="pesquisa">
        ...
        <input type="text" id="pesquisa" name="pesquisa" placeholder="Título da obra ou autor" style="width: 450px" required><br><br>
  ...
  <div id="admin" class="tab" style="display:none">
    <fieldset>
      ...
      <a class="button3" href="./principal/obra/index.php" style="width: 135px">Obras</a><br><br>
